...
, nordigen_requisition_id varchar(255), ynab_refresh_token varchar(255), mapping TEXT NOT NULL DEFAULT '');
...
INSERT INTO sqlite_sequence VALUES('micrate_db_version',6);
COMMIT;
